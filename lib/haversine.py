...
if __name__ == '__main__':
 ...
 hlab = (recalculate_coordinate((60.1948814392, 0, 0)), recalculate_coordinate((24.951253891, 0, 0)))
 vleka = (recalculate_coordinate((60.2378501892, 0, 0)), recalculate_coordinate((24.85871315, 0, 0)))
 kinkki = (recalculate_coordinate((60.1951141357, 0, 0)), recalculate_coordinate((24.9548549652, 0, 0)))
 print "warsaw <-> cracow %fkm" % points2distance(warsaw, cracow)
 print "hlab <-> vleka %fkm" % points2distance(hlab, vleka)
 print "hlab <-> kinkki %fkm" % points2distance(hlab, kinkki)
